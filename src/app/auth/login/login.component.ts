...
export class LoginComponent implements OnInit {
  ...
  // Image
  imgLogo = 'assets/img/logo/kkm.png'
  ...
  login() {
    ...
    else if (this.loginForm.value.username == 'global'){
      this.authService.userRole = 3
      this.navigatePage('notification-global')
  ...
  navigatePage(path: String) {
    ...
    else if (path== 'notification-global'){
      return this.router.navigate(['/global/notification'])
    }
  }
