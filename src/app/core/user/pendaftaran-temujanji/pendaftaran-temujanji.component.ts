...
@Component({
  selector: 'app-pendaftaran-temujanji',
  templateUrl: './pendaftaran-temujanji.component.html',
  styleUrls: ['./pendaftaran-temujanji.component.css']
})
export class PendaftaranTemujanjiComponent implements OnInit {
